...
const PlumbingPage = ({ onEnterDashboard }: { onEnterDashboard: () => void }) => {
  return (
    <IndustryTemplate
      onEnterDashboard={onEnterDashboard}
      title="Plumbing Business Management For Solo Plumbers"
      heroHeadline="Stop Losing Track Of Plumbing Jobs"
      heroSubheadline="Manage emergency calls, estimates, invoices and customer follow-ups from one place."
      heroPlaceholder="[PLUMBING HERO IMAGE PLACEHOLDER]"
      heroCaption="Replace with real plumbing technician photo later."
      heroVisualContent={
        <div className="relative w-full h-full group">
           <img fetchpriority="high" 
             src="/header plumber.webp" 
      ...
      problemsHeadline="Common Plumbing Problems"
      problems={[
        { title: "Emergency Calls Destroy Schedules", description: "Unpredictable jobs make it hard to plan the week." },
        { title: "Seasonal Revenue Fluctuations", description: "Slow seasons eat into your yearly profits." },
        { title: "Customers Never Call Back For Maintenance", description: "Losing out on recurring revenue from existing clients." }
      ]}
      featuresHeadline="How FieldCore Helps Plumbing Businesses"
      features={[
        { 
          title: "Job Scheduling", 
          description: "Manage emergency repairs and scheduled jobs together.", 
          placeholderText: "",
          visualContent: (
              ...
              <div className="absolute -left-4 top-1/4 bg-white/90 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-slate-200/50 w-64 transform -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                ...
                <div className="space-y-2">
                   <div className="bg-sky-50 rounded-lg p-2 border border-sky-100 border-l-4 border-l-sky-500">
                     <p className="text-[10px] font-bold text-slate-700">8:00 AM - Water Heater Install</p>
                   ...
                   <div className="bg-red-50 rounded-lg p-2 border border-red-100 border-l-4 border-l-red-500">
                     <p className="text-[10px] font-bold text-slate-700">1:30 PM - Emergency Leak</p>
                     <p className="text-[9px] text-slate-500">Sarah Jenkins • Burst Pipe</p>
                   </div>
                </div>
              </div>
            </div>
        ...
        { 
          ...
          description: "Know which services create the highest profit margins.", 
          placeholderText: "",
          visualContent: (
            <div className="relative w-full h-full group bg-slate-50">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:20px_20px]"></div>
        ...
        { 
          ...
          description: "Automatically remind customers about water heater servicing and inspections.", 
          placeholderText: "",
          visualContent: (
            <div className="relative w-full h-full group bg-slate-50">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:20px_20px]"></div>
              ...
              <div className="absolute -left-4 top-1/3 bg-white/90 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-slate-200/50 w-64 transform -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                ...
                <div className="bg-white rounded-lg p-3 border border-slate-100 shadow-sm relative overflow-hidden">
                   ...
                   <p className="text-[10px] font-bold text-slate-700">Subject: Annual Plumbing Inspection</p>
                   <p className="text-[9px] text-slate-500 mt-2 leading-relaxed">Hi John, it's time for your annual plumbing and water heater inspection to ensure everything is running efficiently.</p>
        ...
        { 
          ...
          description: "Generate more Google reviews after completed jobs.", 
          placeholderText: "",
          visualContent: (
            <div className="relative w-full h-full group bg-slate-50">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:20px_20px]"></div>
              ...
              <div className="absolute -right-4 top-1/4 bg-white/90 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-slate-200/50 w-64 transform translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-slate-600 leading-relaxed font-medium">"Extremely professional and fast. Fixed our leak within an hour of calling. Highly recommended!"</p>
        ...
        { 
          ...
          description: "Track pipes, fittings, valves, sealants and inventory costs.", 
          placeholderText: "",
          visualContent: (
            <div className="relative w-full h-full group bg-slate-50">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#cbd5e1_1px,transparent_1px)] [background-size:20px_20px]"></div>
              ...
              <div className="absolute -left-4 bottom-1/4 bg-white/90 backdrop-blur-xl rounded-xl p-4 shadow-2xl border border-slate-200/50 w-56 transform -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center bg-slate-50 p-2 rounded border border-slate-100">
                     <div>
                       <p className="text-[10px] font-bold text-slate-900">PVC Pipe 2"</p>
                       <p className="text-[9px] text-slate-500">SKU: PVC-200</p>
                     </div>
                     <span className="text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded">24 in stock</span>
                  </div>
                  <div className="flex justify-between items-center bg-slate-50 p-2 rounded border border-slate-100">
                     <div>
                       <p className="text-[10px] font-bold text-slate-900">Brass Ball Valve 1/2"</p>
                       <p className="text-[9px] text-slate-500">SKU: BV-12-B</p>
                     </div>
                     <span className="text-[10px] font-bold text-amber-600 bg-amber-50 px-2 py-1 rounded">Low: 4 left</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      whyChooseHeadline="Why Plumbers Choose FieldCore"
      whyChooseList={[
      ...
      ctaHeadline="Ready To Organize Your Plumbing Business?"
    />
  );
};
